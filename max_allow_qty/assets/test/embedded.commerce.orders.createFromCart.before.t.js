...
var actionName = 'embedded.commerce.orders.createFromCart.before';

describe('embedded.commerce.orders.createFromCart.before implementing embedded.commerce.orders.createFromCart.before', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.orders/embedded.commerce.orders.createFromCart.before');
  });
