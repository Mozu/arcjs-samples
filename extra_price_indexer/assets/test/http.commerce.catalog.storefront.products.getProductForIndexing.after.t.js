...
var actionName = 'http.commerce.catalog.storefront.products.getProductForIndexing.after';

describe('http.commerce.catalog.storefront.products.getProductForIndexing.after implementing http.commerce.catalog.storefront.products.getProductForIndexing.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.catalog.storefront.products/http.commerce.catalog.storefront.products.getProductForIndexing.after');
  });
