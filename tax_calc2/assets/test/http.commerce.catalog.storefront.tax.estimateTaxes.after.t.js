...
var actionName = 'http.commerce.catalog.storefront.tax.estimateTaxes.after';

describe('http.commerce.catalog.storefront.tax.estimateTaxes.after implementing http.commerce.catalog.storefront.tax.estimateTaxes.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.catalog.storefront.tax/http.commerce.catalog.storefront.tax.estimateTaxes.after');
  });
